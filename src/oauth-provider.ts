...
function formHtml(params: {
  ...
  const scopeText = params.scopes.length > 0 ? params.scopes.join(" ") : "localspace";
  const resourceText = params.resource?.href ?? "LocalSpace MCP endpoint";
...
<html lang="en">
  <head>
    ...
    <title>Connect LocalSpace</title>
    <style>
...
${hiddenFields}
        ...
        <button type="submit">Authorize LocalSpace</button>
      </form>
    </main>
  </body>
</html>`;
